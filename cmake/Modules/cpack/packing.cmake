...
set(CPACK_RPM_DEBUGINFO_FILE_NAME "${CPACK_PACKAGE_NAME}-debuginfo-${CPACK_PACKAGE_VERSION}.${CPACK_RPM_PACKAGE_ARCHITECTURE}.rpm")
...
set(CPACK_RPM_BUILD_SOURCE_DIRS_PREFIX "/usr/src/debug/csc-cm")
set(CPACK_RPM_INSTALL_WITH_EXEC ON)
set(CPACK_RPM_SPEC_MORE_DEFINE "%global _find_debuginfo_dwz_opts -r")
message(STATUS "Building Release package with separate Debuginfo package")
