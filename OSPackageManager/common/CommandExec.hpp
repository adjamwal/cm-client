...
public:
     ...
     */
    static int ExecuteCommand(char *cmd, char * const *argv, int *exitCode);
     ...
     * @return 0 if the command was executed successfully.
     */
    static int ExecuteCommandCaptureOutput(char *cmd, char * const *argv, int *exitCode, std::string &output);
